...
- Product folders and files structured are updated: [README](https://github.com/creativetimofficial/Custom-dashboard-material-ui/blob/main/README.md)
...
- `nouislider` this was used inside Custom Dashboard PRO React, but Material-UI comes with its own slider component
...
- Started project with Material-UI Create-React-App: https://github.com/mui-org/material-ui/tree/master/ui/create-react-app
- Added Material-UI as base framework
- Added React Hooks
- Added design from Custom Dashboard React by Creative Tim
- Added features from Custom Dashboard React by Creative Tim (such as routing system and components)
